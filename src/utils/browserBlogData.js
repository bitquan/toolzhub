// Use Firebase CLI to add blog data
...
// Copy this code and run it in your browser console at https://toolzhub-5014-31157.web.app
// Make sure you're logged in as an admin first

async function createBlogPosts() {
  if (typeof firebase === 'undefined' || !firebase.firestore) {
    console.error(
      "Firebase not available. Make sure you're on the ToolzHub website."
    );
    return;
  }
  ...
  try {
    ...
    console.log(`📝 Created ${blogPosts.length} posts`);
    console.log('🔗 Visit /blog to see your content');
  } catch (error) {
